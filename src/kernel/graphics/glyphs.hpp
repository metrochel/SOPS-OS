...
/// @brief Проверяет, допустима ли устанавливаемая граница.
/// @return Допустимость устанавливаемой границы
/// @note Считается, что граница допустима, если она не переходит за границы экрана, т.е.
/// @note равна от 0 до
